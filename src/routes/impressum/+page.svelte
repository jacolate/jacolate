<div class="pt-7 grid gap-4">
    <h1 class="text-yellow-500 font-medium text-4xl">Impressum</h1> 
    <ul>
        <li>Angaben gemäß § 5 Digitale-Dienste-Gesetz (DDG)</li>
        <li>Jakob Koller</li>
        <li>Steinertstr. 12, 96047 Bamberg</li>
    </ul> 
    <h3 class="font-bold">Kontakt</h3>
    <p>E-Mail: jakobkoller@t-online.de</p> 
    <h2 class="font-bold text-2xl mt-4">Haftungsausschluss</h2>
    <h3 class="font-bold">Haftung für Inhalte</h3>
    <p>
    ...
    <h3 class="font-bold">Haftung für Links</h3> 
    <p>
